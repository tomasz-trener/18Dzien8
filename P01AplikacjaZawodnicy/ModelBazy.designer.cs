...
namespace P01AplikacjaZawodnicy
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="Zawodnicy")]
    ...
    partial void DeleteMiasto(Miasto instance);
		...
		public ModelBazyDataContext() : 
				base(global::P01AplikacjaZawodnicy.Properties.Settings.Default.ZawodnicyConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Miasto : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _id_miasta;
		
		private string _nazwa_miasta;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void Onid_miastaChanging(int value);
    partial void Onid_miastaChanged();
    partial void Onnazwa_miastaChanging(string value);
    partial void Onnazwa_miastaChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_id_miasta", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int id_miasta
		{
			get
			{
				return this._id_miasta;
			}
			set
			{
				if ((this._id_miasta != value))
				{
					this.Onid_miastaChanging(value);
					this.SendPropertyChanging();
					this._id_miasta = value;
					this.SendPropertyChanged("id_miasta");
					this.Onid_miastaChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_nazwa_miasta", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string nazwa_miasta
		{
			get
			{
				return this._nazwa_miasta;
			}
			set
			{
				if ((this._nazwa_miasta != value))
				{
					this.Onnazwa_miastaChanging(value);
					this.SendPropertyChanging();
					this._nazwa_miasta = value;
					this.SendPropertyChanged("nazwa_miasta");
					this.Onnazwa_miastaChanged();
				}
			}
		}
